/**
 * Lado de LECTURA de las notificaciones (listar, contar, marcar leídas).
 *
 * La ESCRITURA vive en `notify.ts`, que es la única puerta de entrada para los
 * services de negocio. La separación es deliberada: el `createNotification`
 * que estaba acá aceptaba un destinatario arbitrario y un `type` string libre,
 * y podía propagar errores hacia la operación que lo llamaba. Nada de eso es
 * posible desde `notify.ts`.
 */
