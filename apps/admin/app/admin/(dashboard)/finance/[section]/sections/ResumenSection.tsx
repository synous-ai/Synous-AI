...
const MonthlyChart = dynamic(
  () => import('./resumen-charts').then((m) => m.MonthlyChart),
  { ssr: false, loading: () => <div className="h-[200px] w-full" /> },
)
const ExpensesPieChart = dynamic(
  () => import('./resumen-charts').then((m) => m.ExpensesPieChart),
  { ssr: false, loading: () => <div className="h-[160px] w-full" /> },
)
const TopDebtorsChart = dynamic(
  () => import('./resumen-charts').then((m) => m.TopDebtorsChart),
  { ssr: false, loading: () => <div className="h-[160px] w-full" /> },
)
