...
import { ShieldCheck, FileText, Globe, Puzzle, Bell, SlidersHorizontal } from 'lucide-react'
...
> = {
  ...
  notifications: {
    ...
    subtitle: 'Elegí qué eventos querés recibir como notificación in-app o por email.',
    icon: Bell,
