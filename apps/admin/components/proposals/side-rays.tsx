...
/**
 * SideRays — fondo de rayos de luz animados con WebGL (ogl). Componente de
 * ReactBits adaptado a TypeScript. `pointer-events-none`, se pausa cuando no
 * está visible (IntersectionObserver) y limpia el contexto WebGL al desmontar.
 */
...
void main() {
  ...
  // Actualización en caliente de uniforms sin re-crear el contexto.
  useEffect(() => {
